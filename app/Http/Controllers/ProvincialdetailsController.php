...
class ProvincialdetailsController extends Controller
{
    public function chiefs()
    {
        ...
        return Inertia::render("Provinceboard/Chief/Index", compact('chiefs', 'filters', 'editDetails'));
    }
    public function headmans(){
        ...
        $filters = FReq::only(['search']);
        return Inertia::render("Provinceboard/Headman/Index", compact('headmans', 'filters','editDetails'));
    ...
    public function villageheads(){
        ...
        $filters = FReq::only(['search']);
        return Inertia::render("Provinceboard/VillageHead/Index", compact('villageheads', 'filters','editDetails'));
