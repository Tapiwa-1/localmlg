            ...
            <div class="py-12">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class=" grid grid-cols-2 gap-20">
                        <div>
                            <Link v-if="editDetails" type="button" class="ml-auto text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br  font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" :href="route('headman.create')">Add Headman</Link>
                            <a type="button" class="ml-auto text-white bg-gradient-to-r from-indigo-500 via-indigo-600 to-indigo-700 hover:bg-gradient-to-br  font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" :href="route('townboard.headman.exportcsv')">Generate Excel</a>
                        </div>
                        <div>
