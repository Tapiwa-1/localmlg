                ...
                <div class="max-w-7xl mx-auto sm:px-2 lg:px-8">
                    <div class=" grid grid-cols-2 gap-20">
                        <div>
                            ...
                            <a type="button" class="ml-auto text-white bg-gradient-to-r from-indigo-500 via-indigo-600 to-indigo-700 hover:bg-gradient-to-br  font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" :href="route('townboard.chief.exportcsv')">Generate Excel</a>
